<footer class="bg-gray-800 py-20 mt-20">
    <div class="grid grid-cols-3 w-4/5 pb-10 m-auto border-b-2 border-gray-700">
        <div>
            <h3 class="text-l font-bold text-gray-100">Pages</h3>
    ...
    <p class="w-25 w-4/5 pb-3 m-auto text-xs text-gray-100 pt-6"> 2023</p>
</footer>
